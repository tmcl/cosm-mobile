...
import * as OsmDiff from "@/scripts/ts-xml-object-parser/osm-diff";
    ...
    export function putApi06ChangesetByChangesetidUploadText(body: OsmChange, changesetid: number): Promise<string> {
      ...
      let params = {};
      console.log(`https://master.apis.dev.openstreetmap.org/api/0.6/changeset/${changesetid}/upload` + "?" + new URLSearchParams((params)).toString(), JSON.stringify(options))
